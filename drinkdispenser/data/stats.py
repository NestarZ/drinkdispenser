...
class Stats:
    ...
    def __init__(self, ingredients, boissons):
        ...
        self.nb_vendu = {boisson: 0 for boisson in self.boissons}
        self.dose_sucre = {boisson: [] for boisson in self.boissons}
        self.with_lait = {boisson: 0 for boisson in self.boissons}
        self.conso_ingredient = {
            ingredient: 0 for ingredient in self.ingredients}
